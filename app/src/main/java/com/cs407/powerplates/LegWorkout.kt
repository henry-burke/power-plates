...
class LegWorkout(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        card1Text.text = getString(R.string.workout_details, "Squats", "Advanced", 10)
        card2Text.text = getString(R.string.workout_details, "Sumo Squats", "Advanced", 20)
        card3Text.text = getString(R.string.workout_details, "Calf Raises", "Advanced", 15)
